...
class Uji_Interst_Admin_API{
	...
	public function init_fields () {
		...
		$fields['title_color'] = array(
								'name' => __( 'Top Bar Text Colors/Title Color', 'ujinter' ), 
		...
		$fields['cont_width'] = array(
								'name' => __( 'Content width', 'ujinter' ), 
								'description' => __( 'Content width and align center. Recommanded to use same as the website width. Leave it empty for 100% width.', 'ujinter' ), 
								'type' => 'text',
								'size' => 4,
								'default' => '',
								'section' => 'style-options'
		...
		$fields['close_name']  = array(
								'name' => __( 'Show close button', 'ujinter' ), 
								'description' => __( 'Choose to view close button. Default is to show', 'ujinter' ), 
								'type' => 'select',
								'default' => 'yes',
								'options' => array( 'yes' => __( 'Yes', 'ujinter' ), 'no' => __( 'No', 'ujinter' ) ), 
								'section' => 'generate-settings'
		...
		$fields['countdown_time'] = array(
								...
								'description' => __( 'Enter how long the interstitial ad will be shows until closing itself. Default is 15 seconds', 'ujinter' ), 
								'type' => 'select',
								'default' => '15',
		...
		$fields['wait_time'] = array(
								...
								'description' => __( 'Enter how long the interstitial shoult wait until will be shown. Default is 0 seconds. Shows instantly.', 'ujinter' ), 
								'type' => 'select',
								'default' => '0',
		...
		$fields['tra_close']  = array(
								'name' => __( '"Close" Link Text', 'ujinter' ), 
								'description' => __( 'The text to display on the "Close" button.', 'ujinter' ), 
								'type' => 'text',
								'default' => 'Close',
